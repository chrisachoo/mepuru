...
export function LinkItem(props: Readonly<{ href: string, label: string, pathname: string }>) {
	...
	return (
		<li>
			<A
				href={props.href}
				classList={{
					"border-l-primary bg-primary/10 text-primary border-l-2": props.pathname === props.href,
