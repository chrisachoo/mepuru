...
const usageImportCode = `import { Button } from "~/components/ui/button"`

const usageExampleCode = `<Button variant="primary">Primary</Button>
...
export default function ButtonPage() {
	return (
		<main class="min-h-screen w-full bg-base-100 relative overflow-x-hidden bg-dot-grid">
			...
			<article class="relative mx-auto w-full max-w-4xl px-6 py-16">
				<div class="space-y-3 animate-fade-in">
					...
					<p class="text-lg text-base-content/70 leading-relaxed">
						Displays a button with variants and sizes. Built with daisyUI and
						class-variance-authority.
					</p>
				</div>

				<section class="mt-10 space-y-4">
					<h2 class="text-xl font-semibold text-base-content">Variants</h2>
          ...
          <h2 class="text-xl font-semibold text-base-content">Sizes</h2>
          <div class="flex flex-wrap items-center gap-3 rounded-xl border border-base-300 bg-base-200/50 p-6">
            ...
            <Button size="lg">Large</Button>
				...
				<section class="mt-10 space-y-4">
					...
					<p class="text-base-content/80 text-sm leading-relaxed">
						Import the component and use it with variant and size props.
					</p>
					<CodeBlock
						title="Import"
