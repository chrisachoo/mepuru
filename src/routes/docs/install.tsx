		...
		>
			<div class="mt-10 space-y-10">
				<section class="space-y-3">
					...
					<CodeBlock code={createProjectCmd} language="bash" />
				</section>
				...
				<section class="space-y-3">
					...
					<CodeBlock	title="Terminal"	code={installDepsCmd}	language="bash" />

					<p class="pt-1 text-sm leading-relaxed text-base-content/80">
						Add Tailwind CSS to your Vite config:
					</p>
					<CodeBlock	title="vite.config.js"	code={viteConfigCode}	language="typescript" />

					<p class="pt-1 text-sm leading-relaxed text-base-content/80">
						Put Tailwind CSS and daisyUI in your CSS file (and remove old
						styles):
					</p>
					<CodeBlock title="src/index.css" code={cssCode} language="css" />
				</section>
				...
				<section class="space-y-3">
					...
					<CodeBlock title="components/ui/button.tsx" code={buttonComponentCode} language="tsx" />
				</section>
