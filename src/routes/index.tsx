...
export default function HomePage() {
	...
	return (
		<main class="scrollbar-hide-until-hover bg-dot-grid relative min-h-0 flex-1 overflow-x-hidden overflow-y-auto bg-base-100">
					...
					<div class="animate-fade-in mx-auto flex max-w-2xl flex-col items-center space-y-6 text-center">
						...
						<div class="grid grid-cols-1 items-center justify-center gap-3 pt-2 md:max-w-80 md:grid-cols-2">
							<Button
								variant="primary"
								class="w-full"
								onClick={() => navigate("/docs/components", { replace: true })}
							>
								Components
							</Button>
							<Button
